...
import static mc.obliviate.blokquests.handlers.ConfigHandler.getLogFile;
...
public class BlokUtils {
	...
	public static void log(String text) {
		try {
			Writer writer = new PrintWriter(new BufferedWriter(new OutputStreamWriter(new FileOutputStream(getLogFile(), true), StandardCharsets.UTF_8)));
